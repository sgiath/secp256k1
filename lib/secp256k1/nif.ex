defmodule Secp256k1.NIF do
  ...
  def ecdsa_sign(_msg_hash, _seckey, _nonce_data),
  ...
  def ecdsa_valid?(_signature, _msg_hash, _pubkey),
    do: :erlang.nif_error({:error, :not_loaded})
  ...
  def schnorr_valid?(_signature, _message, _pubkey),
    do: :erlang.nif_error({:error, :not_loaded})
  ...
  def xonly_seckey_tweak_add(_seckey, _tweak),
    do: :erlang.nif_error({:error, :not_loaded})

  def xonly_pubkey_tweak_add(_pubkey, _tweak),
    do: :erlang.nif_error({:error, :not_loaded})
  ...
  def musig_partial_sig_agg(_session, _partial_sigs),
    do: :erlang.nif_error({:error, :not_loaded})
